    ...
    ***************************************************************************** */
    ...
    var GraphModel = /** @class */ (function () {
        ...
        GraphModel.prototype.loadSync = function (artifacts) {
            ...
            var oldVersion = this.isOldVersion(artifacts.convertedBy);
            var signature;
            if (oldVersion) {
        ...
        GraphModel.prototype.isOldVersion = function (version) {
            if (version) {
                var semVer = version.split('TensorFlow.js Converter v');
                semVer = semVer[0].split('.');
                var majorVer = parseInt(semVer[0], 10);
                var minorVer = parseInt(semVer[1], 10);
